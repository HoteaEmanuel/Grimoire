...
9. Check for any other housekeeping tasks that could be cleaned up
10. In the @context/current-feature.md, check that the `Goals` section is up to date and matches the actual implementation. If there are any discrepancies, report them and format the history to have 1 line space between different features.
