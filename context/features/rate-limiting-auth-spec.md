...
| -------------------------------------------------------------- | ---------- | ------ | ---------- |
| `/api/auth/callback/credentials` (login endpoints like signin) | 5 attempts | 15 min | IP + email |
| `/api/auth/register`                                           | 3 attempts | 1 hour | IP         |
| `/api/auth/forgot-password`                                    | 5 attempts | 1 hour | IP         |
| `/api/auth/reset-password`                                     | 5 attempts | 15 min | IP         |
| `/api/auth/resend-verification`                                | 5 attempts | 15 min | IP + email |
