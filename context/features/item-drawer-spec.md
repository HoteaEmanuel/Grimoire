...
- Use shadcn Drawer component, opens from the right
...
- No separate item page, all in the drawer
...
- Drawer shows a skeleton while fetching
- Modify the item type page to fetch only the data needed for the cards, not the full item details

## Reference

See `context/design/image1.png` for the visual design idea.